...
/**
 * TemplateCards component displays a template card with preview and details.
 *
 * @param {TemplateCardProps} props - The props for the TemplateCards component
 * @returns {JSX.Element} The rendered TemplateCards component
 */
...
marketing...`,
  ...
  return (
    <div className="flex items-center justify-center w-[1000px] h-[532.27px] bg-gradient-to-b from-[#0C0C0C] to-[#030303] rounded-[24px]">
      {/* Notion-Template Preview Container (Left Side) */}
      ...
      {/* Template Details Container (Right Side) */}
