...
/**
 * Hero component displaying the main headline, description, and call-to-action button.
 *
 * @returns {JSX.Element} The rendered Hero component
 */
const Hero: React.FC = () => {
  return (
    <section className="flex flex-col items-center text-center min-h-screen py-16">
